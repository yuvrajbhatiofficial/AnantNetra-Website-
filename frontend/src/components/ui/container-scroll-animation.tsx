...
export const Card: React.FC<CardProps> = ({ rotate, scale, translate, children }) => {
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-white dark:border-[#6C6C6C] p-2 md:p-6 bg-slate-100 dark:bg-[#222222] rounded-[30px] shadow-2xl"
    >
